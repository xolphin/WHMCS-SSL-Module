<div class="notifications col-xs-12" style="margin-top: 5px;" id='man-notif'>

</div>
<div class="accountNoCSR col-xs-6">
    <label for="domain" class="h3style" style="margin-top: 5px;"><strong>{$lang['sslXolphinServerDomain']}</strong>
    </label>
    <input class="form-control" name="domain"  id="domain" required="" />

    <div class="extra" style="margin-top: 10px; display: none">
    ...
    <div class="extraDomainList brdr" style="display: none">
        <div>
    ...
    <div class="form-group">
        <label for="validationType" class="h3style"><strong>{$lang['sslXolphinInformationSelValidType']}</strong><a rel='popover'
                                                                                                                    class="info-popover img-circle"
                                                                                                                    data-placement='right'
                                                                                                                    style="width: 650px;"
                                                                                                                    data-toggle="tooltip" title="{$lang['sslXolphinInformationValidationType']}"
            >
    ...
    <div class="approver-emails brdr" style="display: none">
        <div class="form-group">
    ...
    <textarea class="form-control" name="csr" cols="50" id="csr" rows="10"></textarea>
    <div class="decodeCSR">
        <div class="brdr">
...
<div class="col-xs-6 contact-information" id="contact-info-man-nocsr">
